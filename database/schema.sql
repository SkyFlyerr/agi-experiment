-- Server Agent vNext Database Schema
...
CREATE INDEX idx_chat_messages_platform_id ON chat_messages(platform_message_id);
...
CREATE INDEX idx_reactive_jobs_status ON reactive_jobs(status);
CREATE INDEX idx_reactive_jobs_thread_id ON reactive_jobs(thread_id);
CREATE INDEX idx_reactive_jobs_created_at ON reactive_jobs(created_at DESC);
...
CREATE INDEX idx_approvals_thread_job ON approvals(thread_id, job_id);
...
CREATE INDEX idx_token_ledger_scope ON token_ledger(scope);
